...
void World::init()
{
	...
	for (int i=0; i<100; ++i)
	{
		...
		iLine1 = m_Line1.back() + (rand()%20) - 10;
		iLine2 = m_Line2.back() + (rand()%20) - 10;
		iLine3 = m_Line3.back() + (rand()%20) - 10;
		iLine4 = m_Line4.back() + (rand()%20) - 10;
...
void World::Update(int frequency)
{
	...
	while (m_ThreadRunning)
	{
		...
		m_Line2.push_back( m_Line1.back() + (rand()%20) - 10 );
		m_Line3.push_back( m_Line1.back() + (rand()%20) - 10 );
		m_Line4.push_back( m_Line1.back() + (rand()%20) - 10 );
